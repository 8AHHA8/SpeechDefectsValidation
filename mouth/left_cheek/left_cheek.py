...
import time
from .determine_left_puffed import determine_puffed
from .left_mouth_corner_rectangle import get_left_mouth_corner_rectangle
from .left_optical_flow_vectors import draw_optical_flow_vectors 
from .left_puffed_status import display_puffed_status
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                left_top_left, left_bottom_right = get_left_mouth_corner_rectangle(face_landmarks.landmark, img_width, img_height)
        ...
        timer_text = f'Timer: {int(elapsed_time)}s' if current_puffed_status == "Left Cheek Movement" else ''
